         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6 lg:px-8">
            <div className="flex md:flex-row flex-col-reverse justify-between items-center">
                <div className="md:w-1/2 space-y-2.5 md:text-start text-center">
                    ...
                    {/* <h1 className='text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-50 to-cyan-600'>Ranbir Roy</h1> */}
                    <h1 className='lg:text-7xl md:text-6xl text-5xl font-bold  text-cyan-500'>Ranbir Roy</h1>
